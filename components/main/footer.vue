<template>
    <footer class="main-footer" id="main-footer">
        <div class="container">
            <div class="main-footer-container-inside">
                <div class="partners-box">
                    <div class="partners-list">
                        <ul>
                            <li><a href="#"><img src="/img/footer/1.png" alt="" /></a></li>
                            <li><a href="#"><img src="/img/footer/2.png" alt="" /></a></li>
                            <li><a href="#"><img src="/img/footer/3.png" alt="" /></a></li>
                        </ul>
                    </div>
                </div>
                <div class="main-footer-content">
                    <div class="top-side">
                        <div class="footer-widget-box">
                            ...
                            <p>Все права защищены! <br/>© ООО «ProBilet», 2024</p>
                        </div>
                    ...
                    <div class="bottom-side">
                        <div class="flex-side space stretch">
                            <div class="form-email-subscriber">
                                <input type="text" class="form-control" placeholder="Ваш Email для рассылки" />
                            </div>
                            <div class="app-join-links">
...
.main-footer {
    ...
    .partners-box {
        ...
        &::after {
            border-left: 2px dashed var(--body-color);
