<template>
    <header class="main-header" id="main-header">
        <div class="container">
            <div class="flex-side space">
                <nuxt-link :to="`/${$i18n.locale}`" class="main-logo">
                ...
                <div class="right-side flex-side list list-xs">
                    <nav class="lang-navigation">
                        <ul>
                            <li><button type="button">Ру</button></li>
                            <li><button type="button" class="active">Uz</button></li>
                            <li><button type="button">En</button></li>
                        </ul>
                    </nav>
                    <button type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#252525" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5.4 9.624 4.83-5.27a2.4 2.4 0 0 1 3.54 0l4.83 5.27m2.597 1.297-2.732 8.8a1 1 0 0 1-.955.703H6.555a1 1 0 0 1-.953-.697l-2.79-8.8a1 1 0 0 1 .954-1.303h16.476a1 1 0 0 1 .955 1.297"></path></svg>
                    </button>
                    <button type="button">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="#252525" stroke-width="2" d="M14.818 7.01c0 1.515-1.289 2.865-2.818 2.865S9.182 8.525 9.182 7.01C9.182 5.446 10.516 4 12 4s2.818 1.446 2.818 3.01ZM20 16.778c0 .696-.379 1.457-1.61 2.099C17.126 19.536 15.06 20 12 20s-5.126-.464-6.39-1.123C4.379 18.235 4 17.474 4 16.777c0-.549.513-1.353 2.06-2.08 1.47-.688 3.568-1.141 5.94-1.141s4.47.453 5.94 1.142c1.547.726 2.06 1.53 2.06 2.08Z"></path></svg>
                    </button>
                </div>
            </div>
        </div>
